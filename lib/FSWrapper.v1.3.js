...
function FSWrapper() {
  ...
  this.init = function(doneCallback, errCallback){
...
FSWrapper.prototype.read = function(filename, callback) {
  ...
  new FSWrapper().init(function(rootEntry) {
...
FSWrapper.prototype.isFileExists = function(filename, callback) {

  new FSWrapper().init(function(rootEntry) {
    rootEntry.getFile(filename, {create: false}, gotFileEntry, fail);
  }, function(err){
    if(typeof callback == "function")
      callback(null, {error: err});
  });
